...
%EbN0dB_Vec = 10; % For the first part
%M_vec = 2; % For the first part
%M_vec = 4; % For the first part
%M_vec = 8; % For the first part

EbN0dB_Vec = 3:9; % For the second part include EbN0dB = 7
M_vec = [2 4 8]; % For the second part
